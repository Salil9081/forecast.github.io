...
// fetch('https://api.openweathermap.org/data/2.5/forecast?q=aurangabad'+newName.value+'&appid=5d146e729747a13d5615b0655aa430fe')
...
.catch(err => alert(" Plz Enter Valid City Name OR Try To Check Your Internet Coneciton"))
}
